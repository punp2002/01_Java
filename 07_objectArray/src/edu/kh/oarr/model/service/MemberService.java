...
public class MemberService {
	...
	public MemberService() {// 기본생성자
		...
		memberArr[1] = new Member("user02", "pass02", "계보린", 25, "경주");
	...
	public void displayMenu() {
		...
		do {
			...
			case 0 : System.out.println("프로그램 2종료"); break;
			default : System.out.println("잘못 입력하셨습니다. 다시 입력하세요!");
			}
			
		} while(menuNum != 0); // menuNum이 반복 종료
	...
	public String login() {
		...
		// 2-3) 같다면 로그인 회원정보 객체를 참고할 변수 loginMember에 
		//		현재 접근중인 memArr[i] 요소에 저장된 주소를 얕은 복사
	...
	public String selectMember() {
		...
		// 2)로그인이 되어있는 경우
		// 		현재 로그인한 회원 정보를 출력할 문자열을 만들어서 반환
		// 		이름 , 아이디 , 나이 , 지역
