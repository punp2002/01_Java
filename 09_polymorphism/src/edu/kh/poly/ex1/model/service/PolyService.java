...
public class PolyService {
	...
	public void ex1() {
		...
		Car[] arr = new Car[3]; // 부모타입 참조변수 배열을 선언 및 할당
		// 각 요소 Car 타입 참조변수
		...
		// 상속 + 다형성
		// 상속의 특징 : Car 상속 클래스는 모두 getEngine()을 가지고 있다.
	...
	// 전달받은 Car 또는 자식객체 (Tesla , Spark)의 엔진 , 연료 , 바퀴 갯수를 출력하는 메서드
	...
	public void ex2() {
		...
		System.out.println(arr[1] instanceof Car); // false (Spark와 Tesla 관계 없음)
	...
	public void ex3() {
		...
		// 주의 !
		// "." 연산자 (Tesla) 형변환하는 연산자 보다 우선순위 높음
		// 형변환 하는 부분을 () 로 한번 묶어주고 나서 . 연산을 진행해야
	...
	public void ex5() {
		...
		// -> 실행시에는 정적 바인딩보다 자식(Spark)에서 오버라이딩된
		// toString() 메서드가 우선시 되어 Spark 메서드와 바인딩
		// == 동적바인딩
