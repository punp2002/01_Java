...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// [10, 50, 100] 실제로 arr 배열이 가진 모든 요서의 값을 알고 싶을때
		// Arrays.toString(배열명);
		System.out.println( Arrays.toString(arr) );
		Arrays.toString(arr); // 해당 구문만 출력하면 콘솔에 나오지 않음
	...
	public void ex2() {
		...
		// at edu.kh.array.ex.ArrayExample1.ex2(ArrayExample1.java:94)
		// at edu.kh.array.ex.ArrayRun.main(ArrayRun.java:10)
		// 배열의 인덱스 범위를 벗어남 : 길이가 4칸 짜리 배열인데 , 없는 인덱스 번호인 4에 접근했다.
	...
	public void ex8() {
		...
		// toString() 메서드는 자기자신을 기대로 반환
		
		//System.out.println(str); 을 실행하면
		//str.toString() 이 자동으로 호출됨
		// 대입해둔 문자열 값 자체가 반환됨..
		
		// 주소값 (객체의 해시코드) 을 확인하고 싶다면 아래 처럼 사용....
	...
	public void ex9() {
		...
		// 1. 입력 받은 문자열을 한글자씩 잘라내어 char 배열에 순서대로 저장
		...
		// 2. 문자하나를 입력 받아 일치하는 문자가 char 배열에 몇개 존재하는지 확인
		System.out.print("검색할 문자 입력 : ");
		char ch = sc.next().charAt(0);
		// sc.next() -> String형
		// String.chatAt(0) -> String의 0번째 인덱스 문자 하나를 추출해서 char 형태로 변환
		// "h" -> 'h'
