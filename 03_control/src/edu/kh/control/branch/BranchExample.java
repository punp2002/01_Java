...
public class BranchExample {
	...
	public void ex4() {
		...
		for(int i = 1; i <= 100; i++) {
			...
			if(i % 5 == 0) {
				continue; // 40도 5의 배수이므로 분기문 위치 중요
			}
	...
	public void RSPGame() {
		...
		for(int i = 1; i <= round; i++) { // 입력받은 판 수 만큼 반복
			...
			int random = (int)(Math.random() * 3 + 1); // 1 2 3 중 하나의 랜덤 값
	...
	public void ex5() {
		...
		for(int i = 0; i <= round; i++) {
			...
			System.out.print("컴뷰터는 [%s]를 선택했습니다.");
