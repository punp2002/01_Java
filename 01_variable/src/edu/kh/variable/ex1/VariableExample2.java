...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// 할당된 공간에 이름을 booleanDate 라고 정하겠다.
		
		booleanDate = true; // booleanDate 변수에 true 논리값 집어넣기(대입)
		...
		byte byteNumber = 127; // 128을 넣는 순간 에러 ( 값의 범위 -128~127 까지 )
		// 메모리에 정수값을 저장할 공간을 1byte 할당하고
		// 할당된 공간을 byteNumber 라고 부르겠다.
		// 선언된 byteNumber 변수에 처음으로 (초기값) 127을 넣음
		// --> 초기화 : 처음 변수에 값을 대입하는 행위
		
		short shortNumber = 32767;
		
		// 정수 자료형 기본형 ! int (short, byte는 옛날 코드의 잔재 거의 쓰지 않음)
	...
	// 프로그래밍에서 대입되는 데이터(값 자체)를 리터럴 이라는 단어로도 표현
		...
		// 변수 다입인 float과 일치하지 않아 Type mismatch 라는 에러가 발생
		
		double doubleNumber = 3.141592;
		// double이 실수형 중에서 기본형!
		// 리터럴 표기법이 없는 실수는 자동으로 double 로 인식
		// D or d 를 쓸수는 있다
		
		// 문자형 (char) 리터럴 표기법 : ''(홑따옴표)
		// -> 문자 하나
		char ch = 'A';
		char ch2 = 66; // 유니코드 숫자표기
		...
		// 2. 예약어 사용하면 안됨
		// double final;
		// Syntax error on token "final", invalid VariableDeclarator
		 ...
		 * - 자료형 앞에 final 이라는 키워드를 작성하면 됨
		 * - 상수의 명명 규칙 : 모두 대문자로 작성해야됨, 여러단어 작성 시 _ 사용
		 * 
		 * - 상수를 사용하는 경우
