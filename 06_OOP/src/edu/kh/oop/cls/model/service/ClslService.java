...
// ClsService 와 Student / TestVo는 패키지가 다름
public class ClslService /*extends Student*/{
			// 부모로 Student 클래스를 상속 받음
			// ClsService(자식) <- Student(부모)

	//public ClslService() {} // 기본생성자
	
	public void ex1() {
		// 클래스 접근제한자 확인하기
		Student std = new Student();
		// public class 인 Student는 import 가능(어디서든 접근가능)
		...
		// Student 클래스를 ClsService가 상송 받았으므로
	...
	public void ex3() {
		...
		User u3 = new User("test3", "passwoerd1234");
		// 매개변수 생성자
