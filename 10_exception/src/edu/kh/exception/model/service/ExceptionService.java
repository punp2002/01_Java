...
public class ExceptionService {
	...
	public void ex1() {
		...
		// 발생하는 예외 중에 일부 예외 try-catch 사용 안해도
		// if-else 예외 상황 방지 가능
	...
	public void ex3() {
		...
		try {
			...
			// class.jave.lang.ArithmeticException
			
			System.out.println( e.getMessage() ); // 예외 발생시 출력된 내용
			// / by zero
			
			System.out.println( e ); // e.toSting()
	...
	public void ex4() {
		...
		try {
			...
			System.out.println("methodC에서부터 발생한 예외처리를 ex4에서 잡아 처리함");
		}
	}
