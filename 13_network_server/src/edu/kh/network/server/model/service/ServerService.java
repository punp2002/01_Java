...
public class ServerService {
	...
	public void serverStart() {
		...
		try {
			...
			// PrintWriter.println(문자열) : 주어진 데이터를 문자 형태로 출력하고, 출력 후 줄바꿈 추가
			pw.println(str); // 서버 -> 클라이언트 출력
			...
			// getInetAddress() : 클라이언트에 대한 IP주소 정보를 포함하는 InetAddress 객체 반환해줌
