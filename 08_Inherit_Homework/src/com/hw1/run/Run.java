...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 반복문을 사용하여 키보드로 사원정보를 입력 받고 while 무한 반복문을 통해
		// 계속 추가 할것인지 물어보고, 대소무자 상관없이 y 이면 계속 객체 추가
		// 한명씩 추가 될때마다 카운트함
		...
		for(Employee emp : emps) {
			// [첫번째EMP 객체에 대한 주소, 두번째 ,null, null, nul] null
			// 만약에 emp가 null 이면 반복 종료! 추가
